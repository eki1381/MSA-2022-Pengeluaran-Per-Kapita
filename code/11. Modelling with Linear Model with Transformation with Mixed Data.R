...
auxiliary <- read.csv('C:\\Users\\user\\Documents\\Hobby\\Small Area Estimation MSA 2022\\3. Pengeluaran per Kapita\\dataset\\auxiliary\\auxiliary_linear_transformed.csv')
...
write_xlsx(result$ind, 'C:\\Users\\user\\Documents\\Hobby\\Small Area Estimation MSA 2022\\3. Pengeluaran per Kapita\\result\\FH_trans_mixed.csv')
...
auxiliary <- read.csv('C:\\Users\\user\\Documents\\Hobby\\Small Area Estimation MSA 2022\\3. Pengeluaran per Kapita\\dataset\\auxiliary\\auxiliary_sumsel_linear_transformed.csv')
...
fh <- fh(fixed = lf1, vardir = "VAR", combined_data = dataset, domains = "Kecamatan", method = "ml", MSE = TRUE, transformation = "log", backtransformation = "bc_crude")
result <- estimators(fh, CV = TRUE)
write_xlsx(result$ind, 'C:\\Users\\user\\Documents\\Hobby\\Small Area Estimation MSA 2022\\3. Pengeluaran per Kapita\\result\\FH_trans_mixed_sumsel.csv')
...
auxiliary <- read.csv('C:\\Users\\user\\Documents\\Hobby\\Small Area Estimation MSA 2022\\3. Pengeluaran per Kapita\\dataset\\auxiliary\\auxiliary_kalsel_linear_transformed.csv')
...
fh <- fh(fixed = lf1, vardir = "VAR", combined_data = dataset, domains = "Kecamatan", method = "ml", MSE = TRUE, transformation = "log", backtransformation = "bc_crude")
result <- estimators(fh, CV = TRUE)
write_xlsx(result$ind, 'C:\\Users\\user\\Documents\\Hobby\\Small Area Estimation MSA 2022\\3. Pengeluaran per Kapita\\result\\FH_trans_mixed_kalsel.csv')
