...
write_xlsx(result$ind, 'C:\\Users\\user\\Documents\\Hobby\\Small Area Estimation MSA 2022\\3. Pengeluaran per Kapita\\result\\FH_notrans_bigdata.csv')
...
fh <- fh(fixed = lf1, vardir = "VAR", combined_data = dataset, domains = "Kecamatan", method = "ml", MSE = TRUE)
result <- estimators(fh, CV = TRUE)
write_xlsx(result$ind, 'C:\\Users\\user\\Documents\\Hobby\\Small Area Estimation MSA 2022\\3. Pengeluaran per Kapita\\result\\FH_notrans_bigdata_sumsel.csv')
...
fh <- fh(fixed = lf1, vardir = "VAR", combined_data = dataset, domains = "Kecamatan", method = "ml", MSE = TRUE)
result <- estimators(fh, CV = TRUE)
write_xlsx(result$ind, 'C:\\Users\\user\\Documents\\Hobby\\Small Area Estimation MSA 2022\\3. Pengeluaran per Kapita\\result\\FH_notrans_bigdata_kalsel.csv')
