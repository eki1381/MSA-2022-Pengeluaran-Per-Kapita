...
#The transformation we used here is Log-Transformation#
...
write_xlsx(result$ind, 'C:\\Users\\user\\Documents\\Hobby\\Small Area Estimation MSA 2022\\3. Pengeluaran per Kapita\\result\\FH_trans_podes.csv')
...
fh <- fh(fixed = lf1, vardir = "VAR", combined_data = dataset, domains = "Kecamatan", method = "ml", MSE = TRUE, transformation = "log", backtransformation = "bc_crude")
result <- estimators(fh, CV = TRUE)
write_xlsx(result$ind, 'C:\\Users\\user\\Documents\\Hobby\\Small Area Estimation MSA 2022\\3. Pengeluaran per Kapita\\result\\FH_trans_podes_sumsel.csv')
...
fh <- fh(fixed = lf1, vardir = "VAR", combined_data = dataset, domains = "Kecamatan", method = "ml", MSE = TRUE, transformation = "log", backtransformation = "bc_crude")
result <- estimators(fh, CV = TRUE)
write_xlsx(result$ind, 'C:\\Users\\user\\Documents\\Hobby\\Small Area Estimation MSA 2022\\3. Pengeluaran per Kapita\\result\\FH_trans_podes_kalsel.csv')
